...
const Updatesalary = () => {
 ...
 const exccelData= salaryDetails[0].updatedSalary
  ...
  const handleExportToExcel = () => {
    const data = [
      {
        "UAN Number": exccelData.uan || '',
        "Employee Name": exccelData.firstName || '',
        "Gross Salary": exccelData.gross || '',
        "EPF Wages": exccelData.emp_epf || '',
        "EPS Wages": exccelData.emp_eps || '',
        'EDLI WAGES': exccelData.revised_full_employer_pf <15000 ? exccelData.revised_full_employer_pf : 15000 || '',
        "EPF Contri Remitted": exccelData.epfContribution || '',
        "EPS Contri Remitted": exccelData.epsContribution || '',
        "EPF EPS Diff Remitted": exccelData.epf_eps_diff || '',
        "NCP Days": exccelData.ncpDays || '0',
        "Refund Of Advances": exccelData.refundOfAdvance || ''
      },
    ...
    XLSX.writeFile(workbook, `${employeeInfo.firstName}_Salary_Details.xlsx`);
  };
