...
//   const holidays = useSelector((state) => state.leaveCalendar.holidays);
...
import { Select, Spin, Alert } from 'antd';
import { useDispatch, useSelector } from 'react-redux';
import { fetchHolidaysData } from '../../../../HRModule/Redux/Slices/leaveCalendarSlice';
import '../LeaveCalender/LeaveCalender.css';
...
const LeaveCalendar = () => {
  ...
  const handleYearChange = (value) => {
    setYear(value);
    dispatch(fetchHolidaysData()); // Fetch holidays when the year is changed
  };
